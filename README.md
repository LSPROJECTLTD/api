...
Na documentação não especifica corretamente os sistemas de segurança, porém é necessario Desabilitar os Csrf no sistema.
Para proteger o seu projeto utilize o JWT ( virá pra esse projeto em versões futuras).
